...
// Updated navigation data for the USER
const userNavData = {
  navMain: [
    {
        title:"Main Page",
...

    {
      title: "My Orders",
      url: "/user/orders",
      icon: ShoppingBag, // Icon for past/successful orders
    },
    {
      title: "My Cart",
      url: "/user/cart",
      icon: ShoppingCart, // Icon for items to be purchased
    },
    {
      title: "Profile",
      url: "/user/profile",
    ...
    <Sidebar {...props} className="border-r border-orange-100">
      ...
      <SidebarContent className="bg-white">
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {userNavData.navMain.map((item) => (
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton
                    asChild
                    // BUG FIX: Compare item's URL with the current pathname
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <DropdownMenu>
                ...
                <SidebarMenuButton className="mx-2 rounded-lg hover:bg-orange-100 transition-colors">
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div className="flex flex-col items-start flex-1 min-w-0">
                      ...
                      <span className="text-xs pb-2 text-gray-600 truncate">
                        {data?.user.email || "random@gmail.com"}
                      </span>
                    </div>
              ...
              <DropdownMenuContent
                side="top"
                className="w-[--radix-popper-anchor-width] mb-2 border-orange-200"
              >
                <DropdownMenuItem
                  asChild
                ...
                <DropdownMenuItem
                  ...
                  className="hover:bg-red-50 focus:bg-red-50 text-red-600 focus:text-red-700 cursor-pointer"
                >
